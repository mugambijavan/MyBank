                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        {type === 'sign-up' &&(
                            ...
                            <div className="flex gap-4">
                                ...
                                <CustomInput 
                                control={form.control } name="postalCode" label="PostalCode" placeholder='Example: 00100'
                                />
                            </div>
                            <div className="flex gap-4">
                                <CustomInput 
                                ...
                                />
                                <CustomInput 
                                control={form.control } name="id" label="ID" placeholder='Example: 39100200'
                                />
                            </div>
