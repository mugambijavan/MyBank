...
export const authFormSchema = (type : string)=>  z.object({
  ...
  county:type === 'sign-in'? z.string().optional() : z.string().min(2).max(50),
  postalCode:type === 'sign-in'? z.string().optional() : z.string().min(2).max(20),
  dateOfBirth:type === 'sign-in'? z.string().optional() : z.string().min(8),
  id: type === 'sign-in'? z.string().optional() : z.string().min(8),
  //sign in
